...
/// Screen showcasing the grid-style email list
/// 
/// This demonstrates what a grid-style desktop email list could look like.
/// To use this, navigate to this screen from your app.
class GridEmailListScreen extends StatefulWidget {
  const GridEmailListScreen({super.key});

  @override
  State<GridEmailListScreen> createState() => _GridEmailListScreenState();
}

class _GridEmailListScreenState extends State<GridEmailListScreen> {
