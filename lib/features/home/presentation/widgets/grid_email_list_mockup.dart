...
/// Table-style email list mockup with action focus
/// 
/// Features:
...
class GridEmailListMockup extends StatefulWidget {
  ...
  @override
  State<GridEmailListMockup> createState() => _GridEmailListMockupState();
}

class _GridEmailListMockupState extends State<GridEmailListMockup> {
